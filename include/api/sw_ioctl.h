...
#define SW_API_TUNNEL_UDF_PROFILE_ENTRY_ADD	(30  + SW_API_TUNNEL_OFFSET)
#define SW_API_TUNNEL_UDF_PROFILE_ENTRY_DEL	(31  + SW_API_TUNNEL_OFFSET)
#define SW_API_TUNNEL_UDF_PROFILE_ENTRY_GETFIRST	(32  + SW_API_TUNNEL_OFFSET)
#define SW_API_TUNNEL_UDF_PROFILE_ENTRY_GETNEXT		(33  + SW_API_TUNNEL_OFFSET)
#define SW_API_TUNNEL_UDF_PROFILE_CFG_SET		(34  + SW_API_TUNNEL_OFFSET)
#define SW_API_TUNNEL_UDF_PROFILE_CFG_GET		(35  + SW_API_TUNNEL_OFFSET)
